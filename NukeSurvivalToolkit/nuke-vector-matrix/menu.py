...
try:
    ...
    try:
        ...
        NST_ImageMenu = NST_menu.addMenu('Image', icon = 'ToolbarImage.png', index = 10)
        NST_DrawMenu = NST_menu.addMenu('Draw', icon = 'ToolbarDraw.png', index = 20)
        NST_TimeMenu = NST_menu.addMenu('Time', icon = 'ToolbarTime.png', index = 30)
        NST_ChannelMenu = NST_menu.addMenu('Channel', icon = 'ToolbarChannel.png', index = 40)
        NST_ChannelColor = NST_menu.addMenu('Color', icon = 'ToolbarColor.png', index = 50)
        NST_FilterMenu = NST_menu.addMenu('Filter', icon = 'ToolbarFilter.png', index = 60)
        NST_KeyerMenu = NST_menu.addMenu('Keyer', icon = 'ToolbarKeyer.png', index = 70)
        NST_MergeMenu = NST_menu.addMenu('Merge', icon = 'ToolbarMerge.png', index = 80)
    ...
    print "Cannot Load nuke-vector-tools menu in Transform"