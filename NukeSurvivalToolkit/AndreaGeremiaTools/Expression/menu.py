...
try:
    ...
    try:
        NST_DrawMenu = toolbar.menu("NukeSurvivalToolkit").menu("Draw")
        #print "Found NST/Draw Menu for ExpressionTools AG"
    except:
    ...
    m = NST_DrawMenu.addMenu("Expression Nodes AG", icon = os.path.join(Expression_path, "icon/expr.png"), index=000 )
    ...
    print "Could Not Load Expression AG menu in Draw"